                ...
                if atend_sel["tipo"] == "OS":
                    ...
                    with col_os_e:
                        ...
                        if whats_limpo:
                            ...
                            msg_manutencao = f"Olá, {nome_cli}! O seu equipamento {marca_p} {modelo_p} (Serial: {sn_os}) da Ordem de Serviço Nº {id_lanc_os} já está em manutenção na nossa assistência técnica. Acompanhe o andamento pelo sistema!"
